...
public class graph extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(graph.this, socialskills.class);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(graph.this, playskills.class);
                String email = finalEmail1;
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(graph.this, selfhelpskills.class);
                String email = finalEmail1;
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(graph.this, handlingbehavioralissues.class);
                String email = finalEmail1;
    ...
    private void sendDataToServer(String finalEmail) {
        new SendDataToServer(button, textView15).execute(finalEmail, "socialSkillsPercentage");
        new SendDataToServer(button1, textView16).execute(finalEmail, "playSkillsPercentage");
        new SendDataToServer(button2, textView17).execute(finalEmail, "selfHelpSkillsPercentage");
        new SendDataToServer(button3, textView18).execute(finalEmail, "behavioralIssuesPercentage");
        new SendDataToServer(button4, textView7).execute(finalEmail, "overallPercentage");
    }
