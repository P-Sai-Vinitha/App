...
public class aggressivebehaviour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aggressivebehaviour);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(aggressivebehaviour.this, repetitivebehaviour.class);
    ...
    static class SendDataToServer extends AsyncTask<Object, Void, Void> {
        ...
        protected Void doInBackground(Object... params) {
            ...
            try {
                ...
                URL url = new URL(ip.ipn+"aggressivebehaviour.php");
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipn +"vdv14.php";
