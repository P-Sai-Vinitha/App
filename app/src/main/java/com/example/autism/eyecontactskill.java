...
public class eyecontactskill extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eyecontactskill);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(eyecontactskill.this, pointingskill.class);
    ...
    static class SendDataToServer extends AsyncTask<Object, Void, Void> {
        ...
        protected Void doInBackground(Object... params) {
            ...
            try {
                ...
                URL url = new URL(ip.ipn+"eyecontact.php");
