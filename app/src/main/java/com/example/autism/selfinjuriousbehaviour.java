...
public class selfinjuriousbehaviour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selfinjuriousbehaviour);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Execute AsyncTask to send data to the PHP server
                new SendDataToServer().execute(v1, v2, v3, v4, finalEmail);

                // Start the new activity (pointingskill)
                Intent intent = new Intent(selfinjuriousbehaviour.this, aggressivebehaviour.class);
    ...
    // AsyncTask to send data to the PHP server
    static class SendDataToServer extends AsyncTask<Object, Void, Void> {
        ...
        protected Void doInBackground(Object... params) {
            ...
            try {
                ...
                URL url = new URL(ip.ipn+"selfinjuriousbehaviour.php");
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipn +"vdv13.php";
