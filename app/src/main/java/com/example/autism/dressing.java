...
public class dressing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(dressing.this, eating.class);
    ...
    static class SendDataToServer extends AsyncTask<Object, Void, Void> {
        ...
        protected Void doInBackground(Object... params) {
            ...
            try {
                ...
                URL url = new URL(ip.ipn+"dressing.php");
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipn +"vdv11.php";
