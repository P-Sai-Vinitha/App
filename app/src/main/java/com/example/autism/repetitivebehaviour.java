...
public class repetitivebehaviour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_repetitivebehaviour);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(repetitivebehaviour.this, screaming.class);
    ...
    static class SendDataToServer extends AsyncTask<Object, Void, Void> {
        ...
        protected Void doInBackground(Object... params) {
            ...
            try {
                ...
                URL url = new URL(ip.ipn+"repetitivebehaviour.php");
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipn +"vdv15.php";
