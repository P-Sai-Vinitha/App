...
public class newplayskills extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_newplayskills);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(newplayskills.this,practiseplay.class);
    ...
    static class SendDataToServer extends AsyncTask<Object, Void, Void> {
        ...
        protected Void doInBackground(Object... params) {
            ...
            try {
                ...
                URL url = new URL(ip.ipn+"newplayskill.php");
